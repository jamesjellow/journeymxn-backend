...
const { connectToMongoDB } = require('./mongo.js');
const { ObjectId } = require('bson');

async function recommendCareers(responses){
    //Fetch all question responses from DB
    // response_object = await getStudentResponse(form_id)

    // Update ScoreBreakdownBySkill
    ScoreBreakdownBySkill = await recordScoreBreakdown(responses);
...
// o = ObjectId("609cd4330751504a51f13d14")
